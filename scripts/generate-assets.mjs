#!/usr/bin/env node
/**
 * Generates every brand asset for Foldup from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.04,"y":0.44,"w":0.48,"h":0.48,"r":0.13,"fill":"accentMid"},{"type":"rect","x":0.48,"y":0.08,"w":0.48,"h":0.48,"r":0.13,"fill":"accent"},{"type":"circle","cx":0.72,"cy":0.32,"r":0.09,"fill":"ink"},{"type":"circle","cx":0.28,"cy":0.68,"r":0.09,"fill":"ink"}];
 ...
 */
const MARK = [[1,1,1,1,0.12],[1,0.45,0.45,1,0.12],[1,0.45,1,1,0.45],[1,1,1,0.45,1],[0.12,0.12,0.45,1,1]];
...
console.log('Generating Foldup brand assets\n');
